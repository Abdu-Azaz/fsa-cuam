            ...
            <div class="col-md-4">
                <div class="card border border-2">
                    ...
                    <div class="card-body bg-light">
                        ...
                        <p class="card-text"><small class="text-muted">{{__('messages.coordinator') . ': '.$club->coordinator }}</small></p>
                        <p class="card-text"><small class="text-muted">{{__('messages.founded') . ': '.$club->founded_at }}</small></p>
                    </div>
                </div>
            </div>
        @endforeach
