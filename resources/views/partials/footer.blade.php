<div class="container-fluid bg-dark h-100 text-light mt-5 wow fadeInUp overflow-hidden" data-wow-delay="0.1s"
    style="background:linear-gradient(rgba(10, 19, 48, 0.85), rgba(7, 15, 61, 0.85)),   url({{ url('storage/site/zellij.jpg') }}) center no-repeat">
    <div class="row gx-4">
