<footer class="container-fluid bg-dark h-100 text-light mt-5 overflow-hidden fadeInUp " data-wow-delay="0.1s"
    style="background:linear-gradient(rgba(10, 19, 48, 0.85),
     rgba(7, 15, 61, 0.85)),   
     url({{ url('storage/site/zellij.jpg') }}) 
    ...
    <div class="row gx-4">
        ...
        <div class="col-lg-3 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div class="link-animated d-flex flex-column justify-content-start">
                <a class="text-light mb-2" href="#"><i
                        class="fa fa-map-marker-alt text-warning me-2"></i>{{ __('messages.fsa-address') }}</a>
                <a class="text-light mb-2" href="#"><i
        ...
        <div class="col-lg-3 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div class="link-animated d-flex flex-column justify-content-start">
                ...
                <a class="text-light mb-2" href="https://e-bourse-maroc.onousc.ma"><i
                        class="fas fa-link text-warning me-2"></i>{{ __('messages.events') }}</a>
                        <a class="text-light mb-2" href="https://e-bourse-maroc.onousc.ma"><i
                            class="fas fa-link text-warning me-2"></i>{{ __('messages.howto') }}</a>
